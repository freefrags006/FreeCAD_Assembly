...
class Face():
    def __init__(self, axes, x, y, z, name):
...
class Plot3D(QtGui.QWidget):
    def __init__(self, winTitle="plot3D", parent = None, flags = QtCore.Qt.WindowFlags(0)):
    ...
    def plot(self, x, y, z, name=None):
        """ plot(self, x, y, name=None): Plot a new line and return it.\n x = X values\n y = Y values\n name = Serie name (for legend). """
        self.axes.plot_surface(x, y, z,  rstride=4, cstride=4, color='b')
